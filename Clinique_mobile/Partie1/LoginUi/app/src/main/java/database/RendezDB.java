...
public class RendezDB extends SQLiteOpenHelper {
    ...
    private static String docteurColumn = "docteur";
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        sqLiteDatabase.execSQL("create table " + tableName + "(" + idColumn + " integer primary key autoincrement, " + nameColumn + " text, " + dateColumn + " text,"+docteurColumn+" text " + ")");
    }
        ...
        try {
            ...
            if (cursor.moveToFirst()) {
                do {
                    ...
                    rendez.setDocteur(cursor.getString(3));
                    rendezs.add(rendez);
    ...
    public boolean create(Rendez rendez) {
        try {
            ...
            contentValues.put(docteurColumn, rendez.getDocteur());
