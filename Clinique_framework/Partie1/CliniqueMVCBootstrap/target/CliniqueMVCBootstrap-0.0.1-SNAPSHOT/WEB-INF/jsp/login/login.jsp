...
<spring:url value="/resources/js/jquery-3.3.1.min.js" var="bootstrapMinJSURL"/>
...
.checkbox input:checked ~ span:before{
    background-image: url("${pageContext.request.contextPath}/resources/images/check.png");
...
<body>
    ...
    <div class="container2">
        ...
        <div class="container">
        <div class="align">
            <img class="logo2" src="${pageContext.request.contextPath}/resources/images/logo.png">
            <div class="card">
                <div class="head">
                    <div></div>
                    ...
                    <form name="loginForm" action='<c:url value="j_spring_security_check" />' method="post" >
                        <div class="inputs">
                            ...
                            <div class="input">
                                ...
                                <img src="${pageContext.request.contextPath}/resources/images/pass.png">
                            </div>
                      ...
                      <div>  <button type="submit">Login</button><a class="forgot" href="${pageContext.request.contextPath}/user/signup">don't have an account ?</a></div>
                    </form>
