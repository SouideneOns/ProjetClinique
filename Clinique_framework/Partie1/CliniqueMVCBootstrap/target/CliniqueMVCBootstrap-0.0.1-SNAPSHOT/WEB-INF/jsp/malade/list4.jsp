...
<body>
   ...
   <div class="container2">
	...
	<div class="container">
		<h1 style="color:black;text-decoration: underline;">Rendez-vous</h1>

		</br> </br>

		<form action="${pageContext.request.contextPath}/user/list5/search"
			method="POST" id="searchForm">
			<div class="form-group">
				<input type="text" class="form-control" placeholder="Veuillez entrer le N° CIN"
