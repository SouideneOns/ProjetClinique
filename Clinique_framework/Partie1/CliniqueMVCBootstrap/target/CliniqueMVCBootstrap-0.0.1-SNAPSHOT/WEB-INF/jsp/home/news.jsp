...
<body>
	...
	<h1 style="color:white;position: absolute; top:130px;left:80px;text-decoration: underline;">Health News </h1>
	<div class="container2" style="position:absolute;left:80px;top:230px;">
            

            <div class="row">
                <div class="col-md-4">
                    <div class="single-blog">
                        <p class="blog-meta">By Admin <span>April 29, 2020</span></p>
                        <img src="${pageContext.request.contextPath}/resources/images/news.png">
                        <h2><a href="#">Our first news</a></h2>
                        <p class="blog-text">This is our first news Click to learn more </p>
