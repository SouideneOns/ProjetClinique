...
<body>
	...
	<h1 style="color:white;position: absolute; top:130px;left:80px;text-decoration: underline;">About Us </h1>
	<div class="container2" style="position:absolute;left:80px;top:230px;width:85%">
            ...
            <div class="container3" style="color:black;">
                <div class="row">
                    <div class="col-sm-7">
                        <h4 style="color:black;font-weight:bold;">Name of hospital</h4>
                    ...
                    <div class="col-sm-5">
                        <div class="img-wrap">
                            <img src="${pageContext.request.contextPath}/resources/images/hospital.png" >
                        </div>
                    </div>
                </div>
            </div>
            </section>
            <section  style="position: absolute;top: 500px;width: 90%;left:70px;">
